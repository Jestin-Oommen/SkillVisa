...
const ChapterIdPage = async({
    ...
    return (  
        <>
        {!chapter.isPublished && (
            <Banner variant="warning" label="Chapter is not published"/>
        )}
        <div className="p-6 ">
            <div className="flex items-center justify-between">
                <div className="w-full">
                    ...
                    <div className="flec items-center justify-between w-full">
                        ...
                        <div className="flex flex-col gap-x-2">
                            ...
                            <span>
                                Complete all your fields {completionText}
                            </span>   
                        </div>
                        <ChapterActions
                            disabled={!isComplete}
            ...
            <ChapterAccessForm initialData={chapter} courseId={params.courseId} chapterId={params.chapterId}/>
                ...
                <ChapterVideoForm initialData={chapter} courseId={params.courseId} chatperId={params.chapterId}/>
